                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            @guest
                                @if (Route::has('login'))
                                    <li class="nav-item">
                                        <a class="nav-link border px-4 me-md-2 turquoise login-m"
                                ...
                                @if (Route::has('register'))
                                    <li class="nav-item">
                                        <a class="nav-link border px-4 turquoise"
                                            href="{{ route('register') }}">{{ __('Register') }}</a>
                                    </li>
                                @endif
                            @else
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle turquoise" href="#"
