    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col">Ingridients Desription</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$plate->ingridient_description}}</td>
                <td>{{$plate->price}}</td>
                <td class="d-flex gap-1">
                    <a href="{{route('admin.plates.show', $project)}}" class="btn btn-sm btn-success"><i
                            class="bi bi-eye-fill"></i></a>
                    <a href="{{route('admin.plates.edit', $project)}}" class="btn btn-sm btn-warning"><i
                            class="bi bi-pencil-fill"></i></a>
                    <form action="{{route('admin.plates.destroy', $project)}}" method="POST">
                        @csrf
                        @method('DELETE')
