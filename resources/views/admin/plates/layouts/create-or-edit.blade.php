...
@section('content')
    ...
    <div class="container d-flex justify-content-center">
        {{-- Form --}}
        <form action="@yield('form-action')" class="form-control w-md-75 shadow p-5" method="POST" enctype="multipart/form-data">
            @csrf
            @yield('form-method')
            {{-- Form title --}}
            ...
            <div class="row mb-3">
                <div class="col-12 col-lg-6">
                    ...
                    <input type="file" class="form-control @error('image') is-invalid @enderror" name="image"
                        id="image" value="{{ old('name', $plate->image) }}">
                    {{-- Instruction Messages --}}
                    @include('partials.input-instruction', [
                        'instructionMessages' => [
            ...
            <div class="row mb-3">
                <div class="col-12 col-lg-6">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                        id="name" value="{{ old('name', $plate->name) }}" placeholder="e.g., Spaghetti Carbonara"
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control @error('ngredient_description') is-invalid @enderror" name="ingredient_description"
                        id="ingredient_description" rows="3"
            ...
            <div class="row mb-3">
                <div class="col-12 col-lg-6">
                    ...
                    <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror"
                        name="price" id="price" value="{{ old('price', $plate->price) }}" placeholder="e.g., 123.00"
                        required>
                    {{-- Instruction Messages --}}
                    @include('partials.input-instruction', [
                        'instructionMessages' => [
            ...
            <div class="row mb-3">
                <div class="col-12 col-lg-6">
                    ...
                    @include('partials.input-instruction', [
                        'instructionMessages' => [
                            'If checked, the plate will be published
